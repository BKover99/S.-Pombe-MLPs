...
setwd("/Users/bencekover/Library/CloudStorage/OneDrive-UniversityCollegeLondon/MSci Bahler lab/S.-Pombe-biofilm/Bence folder/QTL mapping/permutations/permutations_new_filtering")
...
pValues1 <- pEst(path="permutations_new_filtering/",
                 scores=r,
...
write.csv(results,"results_new_filtering.csv")
